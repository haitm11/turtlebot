...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'create_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hl/turtlebot/install/${idir}'.  Ask the maintainer 'Nate Koenig <nate@osrfoundation.org>' to fix it.")
    endif()
