...
echo_and_run cd "/home/hl/turtlebot/src/turtlebot_create/create_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/hl/turtlebot/src/turtlebot_create/create_driver/setup.py" \
    build --build-base "/home/hl/turtlebot/build/turtlebot_create/create_driver" \
    install \
    $DESTDIR_ARG \
