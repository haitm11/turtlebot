...
echo_and_run cd "/home/hl/turtlebot/src/turtlebot_create/create_node"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/hl/turtlebot/src/turtlebot_create/create_node/setup.py" \
    build --build-base "/home/hl/turtlebot/build/turtlebot_create/create_node" \
    install \
    $DESTDIR_ARG \
